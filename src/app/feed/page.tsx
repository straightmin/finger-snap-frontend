...
import type { PhotoCard as PhotoCardType, PhotoSortBy, PhotoViewMode } from '@/types/photo';
...
const mockPhotos: PhotoCardType[] = [
  {
    id: "1",
    title: "석양 속 고요한 순간",
    description: "바닷가에서 마주한 석양은 하루의 마지막을 알리는 신호였다. 파도가 발밑을 스치며 남긴 차가운 감촉과 따뜻한 햇살이 만나는 이 순간에서 나는 무언가 깊은 평온함을 느꼈다. 시간이 멈춘 듯한 고요함 속에서 자연이 주는 위로를 온몸으로 받아들였다.",
  ...
  },
  {
    ...
    description: "비에 젖은 아스팔트 위로 반사되는 네온사인들이 도시의 밤을 물들인다. 수많은 사람들이 지나가지만 각자의 세계에 갇혀 있는 듯한 이 순간, 현대인의 고독을 카메라에 담았다. 화려한 불빛 뒤에 숨겨진 진짜 이야기를 찾고 싶었다.",
  ...
  },
  {
    id: "3",
    title: "할머니의 손", 
    description: "80년의 세월이 새겨진 할머니의 손을 보며 시간의 무게를 느꼈다. 주름 하나하나에는 삶의 이야기가, 굳은살에는 사랑하는 가족을 위한 헌신이 담겨 있었다. 이 사진을 통해 우리가 잊고 살았던 소중한 것들을 다시 한번 생각해보게 되었다.",
  ...
  },
  {
    id: "4",
    title: "새벽 안개 속 숲길",
    description: "새벽 5시, 안개가 자욱한 숲길을 걸으며 자연의 신비로움을 마주했다. 발걸음 소리만이 고요함을 깨뜨리는 이 순간, 도시의 소음에 지친 마음이 치유되는 것을 느꼈다. 안개 사이로 스며드는 첫 햇살이 마치 희망의 메시지 같았다.",
  ...
  },
  {
    id: "5",
    title: "카페 창가의 오후",
    description: "창밖으로 스며드는 따스한 오후 햇살과 김이 모락모락 피어오르는 커피 한 잔. 바쁜 일상 속에서 잠시 멈춰 서서 나만의 시간을 갖는 이 순간이 얼마나 소중한지 깨달았다. 단순한 일상 속에서도 아름다움을 발견할 수 있다는 것을 보여주고 싶었다.",
  ...
  },
  {
    id: "6",
    title: "아이의 순수한 미소",
    description: "공원에서 뛰어노는 아이의 천진난만한 미소를 보며 잃어버린 순수함을 떠올렸다. 어른이 되면서 잊고 살았던 단순한 기쁨과 순간의 행복이 무엇인지 다시 생각하게 되었다. 이 미소 하나가 세상의 모든 복잡함을 잊게 만들어 주었다.",
      ...
      <footer className="bg-gray-50 border-t border-gray-200 py-16">
        <div className="max-w-6xl mx-auto px-6 text-center">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
            <div>
              <div className="text-2xl font-light text-black mb-2">10,000+</div>
              <div className="text-sm text-gray-600">사진 이야기</div>
            </div>
            <div>
              <div className="text-2xl font-light text-black mb-2">5,000+</div>
          ...
          <p className="text-gray-500 text-sm">
            © 2024 핀거스냅. 사진 속 감정과 의미를 깊이 있게 나누는 스토리텔링 중심의 사진 커뮤니티입니다.
          </p>
        </div>
      </footer>
    </div>
