...
import { Camera, Upload, X, Plus, Heart, MessageCircle } from "lucide-react";
...
export default function PhotoUploadPage() {
    ...
    const validateFile = (file: File): string | null => {
        ...
        if (
            !UPLOAD_CONSTANTS.ALLOWED_FORMATS.includes(
                file.type as (typeof UPLOAD_CONSTANTS.ALLOWED_FORMATS)[number]
            )
        ) {
                ...
                <div className="max-w-2xl mx-auto px-6 py-8">
                    ...
                    >
                        ...
                        <p className="text-sm text-gray-500 mt-4">
                            JPG, PNG 파일을 지원합니다 (최대{" "}
                            {UPLOAD_CONSTANTS.MAX_FILE_SIZE / 1024 / 1024}MB)
                        </p>
                        {errors.file && (
                        ...
                        <div className="space-y-6">
                            <div>
                                ...
                                <Input
                                    ...
                                    maxLength={
                                        UPLOAD_CONSTANTS.MAX_TITLE_LENGTH
                                    }
                                />
                            ...
                            <div>
                                ...
                                <Textarea
                                    ...
                                    maxLength={
                                        UPLOAD_CONSTANTS.MAX_DESCRIPTION_LENGTH
                                    }
                                />
                                <div className="flex justify-between items-center mt-2">
                                    <p className="text-xs text-gray-500">
                                        {currentImage.description.length}/
                                        {
                                            UPLOAD_CONSTANTS.MAX_DESCRIPTION_LENGTH
                                        }
                                        자
                            ...
                            <div>
                                ...
                                <div className="mt-2 space-y-3">
                                    ...
                                    <p className="text-xs text-gray-500">
                                        사진과 관련된 키워드를 추가하여 다른
                                        사용자들이 쉽게 찾을 수 있도록 해주세요.
